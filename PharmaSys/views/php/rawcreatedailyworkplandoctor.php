...
$sql = 'call insert_mio_visit_doctor(:param1,:param2,:param3,:param4,:param5,:param6,:param7,:param8)';
$result = oci_parse($conn, $sql);
oci_bind_by_name($result, ':param1', $obj->mio_id);
oci_bind_by_name($result, ':param2', $obj->doctor_id);
...
oci_bind_by_name($result, ':param8', $obj->product);
