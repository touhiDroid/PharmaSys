...
<html>
	<head>
		...
		<script type="text/javascript">
			function sentDailyWorkPlanPharmacy() {
				...
				xmlhttp.open("GET", "php/rawcreatedailyworkplanpharmacy.php?q=" + JSON.stringify(jobj), true);
				xmlhttp.send();
	...
	<div id="wrapper">
        ...
        <div id="page-content-wrapper"><br><br><br>
            ...
            <div class="page-content inset">
				<div align="center">
					<h1>
						Create Daily Work Plan for Visiting Pharmacy
					</h1>
					<br>
					<input id="mio_id"    class="form-control" style="width: 50%; text-align:center;" type="text"  placeholder="MIO ID" align="center" />
					<br>
					<input id="pharmacy_id"  class="form-control" style="width: 50%; text-align:center;" type="text"  placeholder="Pharmacy ID"/>
					<br>
					...
					<br>
					<button onclick="sentDailyWorkPlanPharmacy()" class="btn btn-success">Save</button>
				</div>
            </div>
        </div>
    </div>
